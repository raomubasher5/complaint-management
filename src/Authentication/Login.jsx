            ...
            <div className="flex items-center justify-center min-h-screen bg-background pt-20 ">
                <div className="bg-card dark:bg-card bg-blue-gray-100 p-8 rounded-lg shadow-l bg-slate-100 w-full max-w-md flex flex-col items-">
                    <div className='w-full flex justify-center'>
                        <img src="https://suparco.gov.pk/wp-content/uploads/2019/08/logo.png" className='w-1/2 Filter' alt="" />
                    </div>
                    ...
                    <div className="text-center mt-4 text-sm text-primary dark:text-primary-foreground">
                        ...
                        <Link to="/signup" className="text-blue-500 block"> New on SUPARCO? signup</Link>
                    </div>
                </div>
            </div>
            <ToastContainer/>
