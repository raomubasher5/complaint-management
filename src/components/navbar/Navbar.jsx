...
const Navbar = () => {
  return (
    <>
          <div>
                <nav className="flex flex-col md:flex-row items-center justify-between py-4 px-12 border-b border-border fixed bg-white w-full z-10 top-0 ">
                    <div className="text-3xl font-bold mb-4 md:mb-0 md:mr-4"><img src="https://suparco.gov.pk/wp-content/uploads/2019/08/logo.png " className='Filter w-1/2' alt="" /></div>
                    <div>
                        {/* <SearchBar /> */}
                    </div>
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="hidden md:flex items-center font-semibold space-x-12 hover:bg-slate-200 hover:p-3 p-3 hover:rounded-lg">
                            <Link to="/pending-complaints" className="hover:text-primary">Pending complaints</Link>
                        </div>
                        <div className="hidden md:flex items-center font-semibold space-x-12 hover:bg-slate-200 hover:p-3 p-3 hover:rounded-lg">
